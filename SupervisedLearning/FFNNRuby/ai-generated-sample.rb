...
# Backpropagation training example
# Neural Network with 2 input neurons, 5 hidden and 1 output
# Problems: sometimes it doesn't improove: stuck with local minima
# How to solve: ctrl+c - invoke a new execution. Power of random!
...
epochs.times do |epoch|
  ...
  inputs.each_with_index do |input, i|
    ...
    hidden_layer_size.times do |j|
      biases_h += learning_rate * delta_h[j]
    end

    error += (labels[i] - output) ** 2
  end
  error = error / inputs.size
